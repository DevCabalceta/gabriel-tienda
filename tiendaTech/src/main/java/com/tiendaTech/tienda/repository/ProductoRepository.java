...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
    ...
    // Práctica #2:
    // Busca productos que contengan un texto específico en su descripción, ignorando mayúsculas/minúsculas
    public List<Producto> findByDescripcionContainingIgnoreCase(String textoBusqueda);
