...
public class ProductoService {
    ...
    // Método para la Práctica #2
    @Transactional(readOnly = true)
    public List<Producto> consultaPorDescripcion(String textoBusqueda) {
        return productoRepository.findByDescripcionContainingIgnoreCase(textoBusqueda);
    }
