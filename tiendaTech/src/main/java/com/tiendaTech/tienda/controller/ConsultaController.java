...
public class ConsultaController {
    ...
    // Controlador para la Práctica #2
    @PostMapping("/consultaDescripcion")
    public String consultaPorDescripcion(@RequestParam() String textoBusqueda, Model model) {
        // Llamamos al servicio con el texto que ingresó el usuario
        var lista = productoService.consultaPorDescripcion(textoBusqueda);
        
        // Pasamos los resultados y el texto de búsqueda de vuelta a la vista
        model.addAttribute("productos", lista);
